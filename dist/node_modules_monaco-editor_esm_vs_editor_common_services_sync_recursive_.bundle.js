 ...
 */
(self["webpackChunkYourLibraryName"] = self["webpackChunkYourLibraryName"] || []).push([["node_modules_monaco-editor_esm_vs_editor_common_services_sync_recursive_"],{
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/*---------------------------------------------------------------------------------------------\n *  Copyright (c) Microsoft Corporation. All rights reserved.\n *  Licensed under the MIT License. See License.txt in the project root for license information.\n *--------------------------------------------------------------------------------------------*/\n\n\n\n//# sourceURL=webpack://YourLibraryName/./node_modules/monaco-editor/esm/vs/editor/common/services/textModelSync/textModelSync.protocol.js?");
